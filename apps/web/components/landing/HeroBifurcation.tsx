  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden bg-black">
      ...
      <div className="relative z-10 w-full max-w-7xl mx-auto px-4 py-20">
        {/* Live Data Feed - Scrolling Background - HIDDEN FOR NOW (Gamification layer paused) */}
        <div className="absolute inset-0 overflow-hidden pointer-events-none opacity-[0.03] hidden">
          <motion.div
          ...
          >
            NEURAL_SYNC_ACTIVE • OPERATIVES_QUEUED: 1385 • PROTOCOL_STATUS: LIVE
            • NFT_MINT_CAPACITY: 47% • BETA_ACCESS_OPEN • HYDRACORE_ONLINE •
          ...
          >
            BASELINE_OPTIMIZATION_ACTIVE • COGNITIVE_STACK_LOADED •
            ELECTROLYTE_MATRIX: STABLE • SERIALIZED_ACCESS: LIMITED •
          ...
          >
            PRECURSOR_PROTOCOL_INITIALIZING • FOUNDER_ACCESS_TIER_1 •
            MEDALLION_EXTRACTION_READY • NETWORK_STATUS: GLOBAL • SYNC_RATE:
            144Hz •
          </motion.div>
          <motion.div
            className="absolute whitespace-nowrap text-cyan-400 font-mono text-xs"
          ...
          >
            BIOHACKER_COLLECTIVE_ONLINE • EARLY_ACCESS_DISCOUNT_ACTIVE •
            FIELD_TESTING_GROUP_OPEN • LAUNCH_SEQUENCE_2026 • OPTIMIZED_HUMANS:
            +1,385 •
          </motion.div>
        </div>
        ...
        >
          ...
          >
            {/* Animated divider between cards - HIDDEN (single card layout) */}
              ...
              >
                ...
                <div className="absolute top-4 right-4 z-20">
                  <button
                    ...
                    className="group/briefing flex items-center gap-2 px-3 py-2 bg-black/80 border border-cyan-400/40 hover:border-cyan-400 rounded-lg backdrop-blur-sm transition-all hover:shadow-[0_0_15px_rgba(34,211,238,0.5)] hidden"
            ...
            {/* Lore Path - Right/Secondary - HIDDEN FOR NOW (Gamification layer paused) */}
            <motion.div
              onMouseEnter={() => {
                setHoveredSide("lore");
              }}
              ...
              whileTap={{ scale: 0.98 }}
              className="relative group cursor-pointer h-full hidden"
            >
              <div
                className={`absolute -inset-0.5 bg-gradient-to-r from-red-600 to-orange-600 rounded-2xl blur transition-opacity duration-500 ${
                  isLoreActive ? "opacity-100" : "opacity-0"
                }`}
              />
              <div
                className={`relative bg-neutral-900 rounded-2xl p-8 md:p-10 border transition-all duration-500 overflow-hidden h-full min-h-[420px] flex flex-col ${
                  isLoreActive
                    ? "border-red-500/50 shadow-[0_0_40px_rgba(239,68,68,0.3)]"
                    : "border-red-500/20"
                }`}
                style={{
                  backgroundImage: "url(https://i.imgur.com/dvcWGn0.jpeg)",
                  backgroundSize: "cover",
              ...
              >
                ...
                <div className="absolute inset-0 bg-neutral-900/30 -z-10 rounded-2xl" />
                ...
                <div className="flex flex-col items-center justify-center text-center flex-1 py-8 relative z-10">
                  ...
                  <p className="text-neutral-200 text-base md:text-lg leading-relaxed max-w-md mb-8 drop-shadow-[0_2px_8px_rgba(0,0,0,0.9)]">
                    Discover your operative archetype and unlock exclusive
                    digital rewards.
                  </p>
                  ...
                  <div className="mb-6">
                    <div className="px-4 py-2 bg-red-500/40 backdrop-blur-md border-2 border-red-500/80 rounded-full shadow-lg shadow-red-500/50">
                      <span className="text-xs font-mono text-red-200 tracking-wider drop-shadow-[0_2px_8px_rgba(0,0,0,1)] font-semibold">
                        LORE JOURNEY
                      </span>
                    </div>
                  </div>
                  ...
                  <button
                    onClick={(e) => {
                      ...
                      const twoWaysSection =
                        document.getElementById("two-ways-to-play");
                      if (twoWaysSection) {
                        twoWaysSection.scrollIntoView({
                          behavior: "smooth",
                          block: "start",
                        });
                      }
