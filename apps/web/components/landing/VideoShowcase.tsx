  ...
  useEffect(() => {
    ...
    const spinInterval = setInterval(() => {
      ...
      setTimeout(() => {
        ...
        setCurrentNumbers(sequences[sequenceIndex]!);
        setIsSpinning(false);
      ...
      <div className="absolute inset-0 bg-gradient-to-b from-neutral-950 via-black to-neutral-950">
        ...
        <div className="absolute inset-0 opacity-12 pointer-events-none">
          <div
            ...
            style={{
              backgroundImage:
                "linear-gradient(rgba(239, 68, 68, 0.85) 1.5px, transparent 1.5px), linear-gradient(90deg, rgba(239, 68, 68, 0.85) 1.5px, transparent 1.5px)",
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4">
        ...
        >
          ...
          <div
            ...
            style={{
              backgroundImage: "url(/images/3D3shvu.webp)",
          ...
          <div className="absolute inset-0 -mx-8 md:-mx-16 lg:-mx-24 -my-16 bg-red-500/45 md:bg-red-500/40 mix-blend-overlay" />
          ...
          <div className="relative z-10">
            ...
            <p className="text-xl text-neutral-400 max-w-3xl mx-auto mb-4">
              4 secret digits scattered across HydrCore Base. Characters hide
              clues. Terminals contain codes.
            </p>
                    ...
                    <div className="mb-6 text-center">
                      ...
                      <p className="text-cyan-100 font-mono text-sm md:text-base mb-2">
                        <span className="text-cyan-300 font-bold">
                          PRE-LAUNCH EMAIL SIGNUP REQUIRED
                        </span>{" "}
                        TO PLAY
                      </p>
                      <p className="text-cyan-400/80 font-mono text-xs">
                        Join the waitlist to unlock scan eligibility + exclusive
                        launch access
                      </p>
                    </div>
        ...
        <div className="grid lg:grid-cols-[1fr_280px] gap-8 max-w-6xl mx-auto">
                ...
                {[
                  {
                    ...
                    image: "/images/H43dZi2.webp",
                    hint: "First digit",
                  },
                  {
                    name: "VESPARA",
                    role: "Chief Neural Integration Officer",
                    image: "/images/7rF3Rd5.webp",
                    hint: "Second digit",
                  },
                  {
                    name: "LUNO",
                    role: "Lead Mission\nEngineer",
                    image: "/images/xOlsna0.webp",
                    hint: "Third digit",
                  },
                  {
                    name: "ZENARA",
                    role: "Director of Flow Dynamics",
                    image: "/images/giDeBcH.webp",
                    hint: "Final digit",
                  },
                ].map((character, index) => (
                  <motion.div
                    ...
                    <div className="relative aspect-[9/16] rounded-xl overflow-visible border border-red-500/20 hover:border-red-500/50 transition-all duration-300 hover:scale-125 hover:z-50 hover:shadow-[0_0_40px_rgba(239,68,68,0.6)]">
                      <div className="absolute inset-0 rounded-xl overflow-hidden">
                        ...
                        <div className="absolute bottom-0 left-0 right-0 p-2 bg-gradient-to-t from-black to-transparent">
                          ...
                          <div className="text-sm text-red-400 font-mono drop-shadow-[0_0_6px_rgba(248,113,113,0.9)] whitespace-pre-line">
                            {character.role}
                          </div>
                        </div>
            ...
            >
              ...
              <div className="relative bg-black/90 backdrop-blur-sm border-2 border-red-500/50 rounded-2xl p-8">
                <div className="flex items-start gap-4 mb-6">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-neutral-300 leading-relaxed mb-3">
                      Explore HydrCore Base thoroughly. Numbers are{" "}
                      <span className="text-red-400 font-bold">
                        encrypted in character dialogues
                      </span>
                      ,{" "}
                      <span className="text-cyan-400 font-bold">
                        hidden in terminal interfaces
                      </span>
                      , and{" "}
                      <span className="text-yellow-400 font-bold">
                        secretly coded in visuals
                      </span>
                      .
                    </p>
                    <div className="bg-red-500/10 border border-red-500/30 rounded p-3 mb-3">
                      <p className="text-sm text-red-400 font-mono drop-shadow-[0_0_8px_rgba(248,113,113,0.9)]">
                        💡 HINT: Each of the 4 characters holds exactly 1 digit.
                        Watch their reels. Read the terminals. Decode the
                        messages.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-neutral-300 leading-relaxed">
                        Solve the sequence → Claim physical Medallion with{" "}
                        <span className="text-cyan-400 font-mono">
                          engraved VR access code
                        </span>{" "}
                        → Unlock{" "}
                        <span className="text-white font-semibold">
                          HydrCore Base VR worlds
                        </span>{" "}
                        with exclusive missions, prize drops & evolving
                        gameplay.
                      </p>
                    </div>
                  </div>
                ...
                >
                  ...
                  <div
                    className="absolute -inset-0.5 bg-gradient-to-r from-purple-500 via-cyan-500 to-purple-500 rounded-lg opacity-75 blur-sm group-hover/terminal:opacity-100 transition-all"
                    style={{
                      animation:
          ...
          >
            <div className="lg:sticky lg:top-24">
              <h3 className="text-sm text-red-400 font-mono tracking-wider mb-4 flex items-center gap-2 hidden md:flex">
                <TrendingUp className="w-4 h-4" />
                LIVE EXTRACTIONS
              </h3>
              <div className="bg-neutral-900/50 border border-red-500/20 rounded-xl p-4 space-y-3 h-[500px] overflow-hidden hidden md:block">
                {[
                  ...
                  >
                    ...
                    <div className="flex-1">
                      <div className="text-white font-mono">
                        Operative{" "}
                        <span className="text-red-400">{entry.operative}</span>
                      </div>
              ...
              >
                ...
                <div
                  className="relative p-4 bg-gradient-to-br from-neutral-950 via-black to-neutral-950 border-2 border-cyan-500/50 rounded-lg shadow-2xl"
                  style={{
                    boxShadow:
                ...
                >
                  ...
                  <div className="relative flex justify-center group/medallion cursor-pointer">
                    ...
                    <div
                      ...
                      style={{
                        backgroundImage:
                          "repeating-linear-gradient(0deg, transparent, transparent 8px, rgba(6, 182, 212, 0.2) 8px, rgba(6, 182, 212, 0.2) 9px), repeating-linear-gradient(90deg, transparent, transparent 8px, rgba(6, 182, 212, 0.2) 8px, rgba(6, 182, 212, 0.2) 9px)",
                      }}
                    />

                    {/* Medallion Image */}
                    <img
                      src="/images/4JfT8q9.webp"
