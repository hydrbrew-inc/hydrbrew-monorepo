  ...
  const agiSignals = [
    {
      ...
      role: "CEO, OpenAI",
      quote:
        "We are now confident we know how to build AGI as we have traditionally understood it… It is possible that we will have superintelligence in a few thousand days.",
      category: "optimist",
    },
    {
      author: "Elon Musk",
      role: "CEO, xAI/Tesla",
      quote:
        "My guess is that we'll have AI that is smarter than any one human probably by the end of next year.",
      category: "optimist",
    },
    {
      author: "Dario Amodei",
      role: "CEO, Anthropic",
      quote:
        "I think AGI is coming in the near term... possibly as early as 2026 or 2027. It will be a 'country of geniuses in a data center.'",
      category: "optimist",
    },
    {
      ...
      quote:
        "AI will do all the things that we can do... the rate of progress will become really extremely fast, resulting in unimaginable things.",
      category: "optimist",
    },
    {
      author: "Shane Legg",
      ...
      quote:
        "I've had roughly the same timeline for 15 years: a 50% probability of AGI by 2028, with the mode of that distribution being 2025.",
      category: "optimist",
    },
    {
      ...
      quote:
        "I predict AGI in 2027 and ASI (Artificial Superintelligence) by 2029.",
      category: "optimist",
    },
    {
      ...
      role: "Google AI",
      quote:
        "The possibility of direct access to ASI increases month by month.",
      category: "optimist",
    },
    {
      author: "Ben Goertzel",
      role: "SingularityNET",
      quote:
        "It seems quite plausible we could get to human-level AGI within the next three to eight years.",
      category: "optimist",
    },
    {
      author: "Emad Mostaque",
      role: "Former CEO, Stability AI",
      quote:
        "There will be no programmers in five years. We are moving toward a world of 100% automated intelligence.",
      category: "optimist",
    },
    {
      ...
      role: "Anduril",
      quote:
        "The timeline to AGI is much shorter than most people realize. We are seeing a massive compression of the R&D cycle.",
      category: "optimist",
    },
    {
      ...
      quote:
        "We'll have something that exhibits all the cognitive capabilities humans have maybe in the next five to ten years, possibly the lower end of that.",
      category: "pragmatist",
    },
    {
      author: "Jensen Huang",
      role: "CEO, NVIDIA",
      quote:
        "If AGI is defined as passing human tests, it will be achieved within five years. AI shouldn't just answer; it should do research first.",
      category: "pragmatist",
    },
    {
      author: "Ray Kurzweil",
      role: "Futurist/Google",
      quote:
        "I predicted 2029 for AGI in 1999 and I still predict 2029. By then, everyone will accept it.",
      category: "pragmatist",
    },
    {
      ...
      quote:
        "AGI will be achieved in 5-7 years. Existing hardware cannot support it yet; we need 2-5 generations of chip upgrades.",
      category: "pragmatist",
    },
    {
      ...
      quote:
        "I used to think it was 30 to 50 years away. I now think AGI will be achieved in 3-5 years, but it may cause human extinction within 10.",
      category: "pragmatist",
    },
    {
      author: "Andrew Ng",
      role: "Stanford/DeepLearning.AI",
      quote:
        "The path to AGI is likely much longer than the current hype suggests, but the progress in reasoning is real and accelerating.",
      category: "pragmatist",
    },
    {
      ...
      role: "DeepMind",
      quote:
        "We are entering the 'age of research' where big computers aren't enough; we need human-like generalization principles.",
      category: "pragmatist",
    },
    {
      author: "Bill Gates",
      role: "Microsoft",
      quote:
        "The development of AI is as fundamental as the creation of the microprocessor. AGI is coming, but it will be a gradual arrival over this decade.",
      category: "pragmatist",
    },
    {
      author: "Yann LeCun",
      ...
      quote:
        "LLMs are not a road toward AGI. They don't understand the physical world, they can't plan, and they can't reason. We are stuck with dog-level AI first.",
      category: "skeptic",
    },
    {
      author: "Gary Marcus",
      ...
      quote:
        "AGI cannot be achieved with existing technology. Deep learning has fundamental flaws and requires theoretical breakthroughs.",
      category: "skeptic",
    },
    {
      author: "Pedro Domingos",
      role: "Author, The Master Algorithm",
      quote:
        "AGI is a pipe dream for now. Existing technology lacks the theoretical support for true general intelligence.",
      category: "skeptic",
    },
    {
      author: "Fei-Fei Li",
      role: "Stanford",
      quote:
        "We need to focus on human-centered AI. True AGI requires an understanding of nuance and context that current models don't possess.",
      category: "skeptic",
    },
    {
      ...
      quote:
        "The 'common sense' gap in AI is much wider than people think. We are nowhere near the level of a human toddler.",
      category: "skeptic",
    },
    {
      ...
      quote:
        "Don't mistake clear progress in one domain for general intelligence. We are still decades away from a robot that can truly navigate the world like a human.",
      category: "skeptic",
    },
    {
      author: "François Chollet",
      role: "Google/Keras Creator",
      quote:
        "Intelligence is about the ability to learn new skills, not just recall data. LLMs are not a path to AGI because they cannot handle novel situations.",
      category: "skeptic",
    },
  ];
      ...
      <div className="absolute inset-0">
        ...
        <div className="absolute inset-0 opacity-12 pointer-events-none">
          <div
            ...
            style={{
              backgroundImage:
                "linear-gradient(rgba(34, 197, 94, 0.85) 1.5px, transparent 1.5px), linear-gradient(90deg, rgba(34, 197, 94, 0.85) 1.5px, transparent 1.5px)",
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4">
        ...
        >
          ...
          <div className="absolute inset-0 -top-40 -bottom-40 flex items-center justify-center pointer-events-none overflow-hidden">
            <div className="relative w-full max-w-5xl h-full">
              <img
                src="/images/nBujlj7.webp"
                alt=""
                className="w-full h-full object-cover opacity-50"
                style={{
                  filter:
                    "brightness(0.7) contrast(1.5) saturate(0.7) hue-rotate(90deg)",
                  mixBlendMode: "screen",
              ...
              <div
                ...
                style={{
                  backgroundImage:
                    "repeating-linear-gradient(0deg, transparent, transparent 2px, rgba(34,197,94,0.15) 2px, rgba(34,197,94,0.15) 4px)",
          ...
          >
            ...
            <p className="text-green-400 font-mono text-sm md:text-base relative z-10">
              ...
              <span
                style={{
                  textShadow:
                    "1px 0 rgba(255,0,0,0.2), -1px 0 rgba(0,255,255,0.2)",
        ...
        <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 mb-16">
          ...
          >
            ...
            <div className="border-4 border-green-500 bg-black p-8">
              <div className="flex items-center justify-between mb-6 pb-4 border-b-2 border-green-500/30">
                <h3 className="text-green-400 font-mono text-sm tracking-widest">
                  GLOBAL AGI CLOCK
                </h3>
              ...
              <div className="mb-4 text-center pb-4 border-b border-green-500/20">
                <div className="text-xs font-mono text-green-500/60 mb-1">
                  COUNTDOWN TO
                </div>
                <div className="text-sm font-mono text-green-400">
                  07/01/2030 00:00:00 UTC
                </div>
              </div>
              ...
              <div className="grid grid-cols-4 gap-4">
                {[
                  {
                    label: "DAYS",
                    value: String(timeRemaining.days).padStart(2, "0"),
                  },
                  {
                    label: "HRS",
                ...
                <div className="flex items-start gap-3 relative z-10">
                  ...
                  <div>
                    ...
                    >
                      ...
                      from the Global AGI Clock. Scan to become part of the AGI
            ...
            {/* Circular HUD Radar */}
            <div className="hidden md:block border-4 border-green-500 bg-black p-8">
              ...
              <div className="relative w-full aspect-square max-w-sm mx-auto">
                ...
                {quadrants.map((quadrant, index) => {
                  ...
                  return (
                    ...
                    >
                      <div
                        className={`w-16 h-16 rounded-full bg-gradient-to-br ${quadrant.color} to-green-900 border-2 border-green-400 flex items-center justify-center mb-2`}
                      >
                ...
                <motion.div
                  ...
                  style={{
                    background:
                      "conic-gradient(from 0deg, transparent 0deg, rgba(34,197,94,0.3) 30deg, transparent 60deg)",
                  }}
                  animate={{ rotate: 360 }}
            ...
            <div className="hidden border-4 border-cyan-500 bg-black p-8">
              <div className="flex items-center justify-between mb-6 pb-4 border-b-2 border-cyan-500/30">
                <h3 className="text-cyan-400 font-mono text-sm tracking-widest">
                  NFT + VR ACCESS HITS
                </h3>
              ...
              <div className="mb-6 bg-cyan-500/10 border-2 border-cyan-500 p-4">
                <div className="text-center">
                  <div className="text-xs font-mono text-cyan-500/70 mb-1">
                    CHARACTER NFT POOL
                  </div>
                  <div
                  ...
                  return (
                    ...
                    >
                      ...
                      {hit.locked ? (
                        ...
                        <Zap
                          className={`w-3 h-3 ${isWinner ? "text-white" : "text-cyan-400"} ${isWinner || isScanning ? "animate-pulse" : ""}`}
                        />
                      ) : (
              ...
              <div className="mt-6 pt-4 border-t border-cyan-500/30">
                <div className="flex items-center justify-between text-xs font-mono mb-2">
                  ...
                  <span style={{ color: "#00FFFF" }}>16 WINNERS</span>
                </div>
                <div className="flex items-center justify-between text-xs font-mono mb-2">
            ...
            <motion.div
              ...
              className="hidden md:block border-4 border-cyan-500 bg-black p-2 relative overflow-hidden"
            >
              {/* Glowing corners */}
          ...
          >
            ...
            <div className="border-4 border-green-500 bg-black p-8">
              ...
              <div className="mb-8">
                <div className="flex items-end justify-between mb-4">
                  <div>
                    <div className="text-xs font-mono text-green-500/70 mb-1">
                      SCANS RECORDED
                    </div>
                    <motion.div
                ...
                <div className="relative h-8 bg-green-950 border-2 border-green-500">
                  <motion.div
                    ...
                    animate={
                      isInView
                        ? { width: `${(currentScans / targetScans) * 100}%` }
                        : {}
                    }
                  ...
                  >
                    <div className="flex items-center justify-between mb-2">
                      <div className="flex items-center gap-3">
                        <div
                          className={`w-3 h-3 bg-gradient-to-br ${quadrant.color} to-green-900`}
                        />
            ...
            <div className="hidden border-4 border-green-500 bg-black p-8">
              <div className="flex items-center justify-between mb-6 pb-4 border-b-2 border-green-500/30">
                <h3 className="text-green-400 font-mono text-sm tracking-widest">
                  CASH PRIZE HITS
                </h3>
                  ...
                  return (
                    ...
                    >
                            ...
                            return (
                              <motion.div
                                ...
                                style={{
                                  ...
                                  top: "50%",
                                  filter:
                                    "drop-shadow(0 0 4px rgba(34, 197, 94, 1))",
                                }}
                                initial={{ x: 0, y: 0, opacity: 1 }}
                                animate={{
                      ...
                      {hit.locked ? (
                        ...
                        <Zap
                          className={`w-4 h-4 ${isWinner ? "text-white" : "text-green-400"} ${isWinner || isScanning ? "animate-pulse" : ""}`}
                        />
                      ) : (
            ...
            <div className="hidden md:block border-4 border-yellow-500 bg-black p-8">
              <div className="flex items-center justify-between mb-6 pb-4 border-b-2 border-yellow-500/30">
                <h3 className="text-yellow-400 font-mono text-sm tracking-widest">
              ...
              <div className="mb-4 flex items-center justify-between">
                ...
                <div
                  className={`text-xs font-mono px-2 py-1 border ${
                    agiSignals[currentSignalIndex]!.category === "optimist"
                      ? "border-green-500 bg-green-500/10 text-green-400"
                      : agiSignals[currentSignalIndex]!.category ===
                          "pragmatist"
                ...
                >
                  {agiSignals[currentSignalIndex]!.category === "optimist" &&
                    "⚡ OPTIMIST: AGI <2 YEARS"}
                  {agiSignals[currentSignalIndex]!.category === "pragmatist" &&
                    "⏳ PRAGMATIST: AGI 3-5 YEARS"}
                  {agiSignals[currentSignalIndex]!.category === "skeptic" &&
                    "⚠️ SKEPTIC: AGI >5 YEARS"}
                </div>
              </div>
              ...
              <div className="bg-black/50 border-2 border-yellow-500/30 p-4 min-h-[200px] font-mono text-sm">
                ...
                <div className="mb-3 pb-2 border-b border-yellow-500/20">
                  <div className="text-yellow-400 text-xs mb-1">
                    &gt; SIGNAL SOURCE: {agiSignals[currentSignalIndex]!.author}
                  </div>
                  <div className="text-yellow-500/60 text-xs">
                    &gt; ROLE: {agiSignals[currentSignalIndex]!.role}
                  </div>
                </div>
              ...
              <div className="mt-4 pt-3 border-t border-yellow-500/30">
                <div className="flex items-center justify-between text-xs font-mono mb-2">
                  ...
                  <span className="text-yellow-400">
                    {currentSignalIndex + 1} / {agiSignals.length}
                  </span>
                </div>
              ...
              <div className="mt-4 bg-yellow-500/5 border border-yellow-500/20 p-3 rounded">
                <div className="text-xs font-mono text-yellow-400/80 mb-2">
                  SIGNAL CATEGORIES:
                </div>
                <div className="space-y-1 text-xs font-mono">
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-green-400">
                      10 Optimists (AGI &lt;2 years)
                    </span>
                  </div>
                  <div className="flex items-center gap-2">
                    <div className="w-2 h-2 bg-yellow-500" />
                    <span className="text-yellow-400">
                      8 Pragmatists (AGI 3-5 years)
                    </span>
                  </div>
                  <div className="flex items-center gap-2">
                    <div className="w-2 h-2 bg-red-500" />
                    <span className="text-red-400">
                      7 Skeptics (AGI &gt;5 years)
                    </span>
                  </div>
                </div>
              </div>
            ...
            <motion.div
              ...
              className="hidden md:block border-4 border-yellow-500 bg-gradient-to-br from-yellow-500/20 via-yellow-400/10 to-yellow-500/20 p-8 relative overflow-hidden"
              style={{
                boxShadow:
                  "0 0 30px rgba(234,179,8,0.5), inset 0 0 20px rgba(234,179,8,0.1)",
              }}
            >
              {/* Corner accents */}
                ...
                <div className="space-y-3 max-w-md mx-auto">
                  <div className="flex items-center gap-3 bg-black/50 border-2 border-yellow-500/50 p-3 rounded">
                    ...
                    <div className="text-left text-sm font-mono text-yellow-100">
                      <span className="text-yellow-400 font-bold">BUY</span>{" "}
                      hydrbrew° at launch
                    </div>
                  </div>
                  ...
                  <div className="flex items-center gap-3 bg-black/50 border-2 border-yellow-500/50 p-3 rounded">
                    ...
                    <div className="text-left text-sm font-mono text-yellow-100">
                      <span className="text-yellow-400 font-bold">SCAN</span> QR
                      code on can
                    </div>
                  </div>
