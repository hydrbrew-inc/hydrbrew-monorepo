                  ...
                  <div className="absolute inset-0 pointer-events-none opacity-20 md:opacity-30">
                    {precursor.name === "Caffeine" && (
                      <div
                        ...
                        style={{
                          backgroundImage:
                            "url(https://i.imgur.com/p4iy3vq.jpeg)",
                    ...
                    {precursor.name === "L-Theanine" && (
                      <div
                        ...
                        style={{
                          backgroundImage:
                            "url(https://i.imgur.com/5oFWKa4.png)",
                    ...
                    {precursor.name === "Lion's Mane" && (
                      <div
                        ...
                        style={{
                          backgroundImage:
                            "url(https://i.imgur.com/1QM0Ftl.jpeg)",
                          filter: "brightness(1.3) contrast(0.9)",
                        }}
                      />
                    )}
                    {precursor.name === "Hydration Layer" && (
                      <div
                        ...
                        style={{
                          backgroundImage:
                            "url(https://i.imgur.com/uARXRtG.png)",
                          filter: "brightness(1.3) contrast(0.9)",
                        }}
                      />
                    )}
        ...
        <div className="relative mt-16 h-[600px] md:h-[80vh] lg:h-[100vh]">
          ...
          <div className="absolute inset-0 overflow-hidden rounded-3xl">
            ...
            >
              {/* The actual image */}
              <img
                src="https://i.imgur.com/r4yd2z5.jpeg"
