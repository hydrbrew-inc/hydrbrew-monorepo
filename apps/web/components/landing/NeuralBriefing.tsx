...
const briefings: Record<string, BriefingConfig> = {
  precursorModel: {
    ...
    transcript: [
      {
        time: 0,
        text: "Standard stimulants force a response. hydrbrew° facilitates one.",
      },
      {
        time: 5,
        text: "We call this the Precursor Model: a precise stack of six clinically validated compounds designed to support a sustained flow state while minimizing systemic crashes.",
      },
      {
        time: 18,
        text: "We lead with a specific ratio of L-Theanine to Caffeine. This isn't just energy—it's smoothed activation.",
      },
      {
        time: 25,
        text: "By pairing high-purity L-Theanine with a low caffeine substrate, we aim to maintain mental alertness while keeping you in a state of parasympathetic flow.",
      },
      {
        time: 37,
        text: "Next, we introduce Lion's Mane—a neurogenesis catalyst.",
      },
      {
        time: 42,
        text: "This shifts the focus from a nervous system 'jolt' to cognitive clarity. This extract supports neural signaling and mood, helping you identify a stable focus curve.",
      },
      {
        time: 53,
        text: "Finally, the hydration layer. A cellular-level infusion of Sodium, Potassium, and Magnesium.",
      },
      {
        time: 60,
        text: "These intracellular electrolytes correlate with improved fluid balance and normal relaxation processes.",
      },
      {
        time: 67,
        text: "While traditional coffee can deplete, hydrbrew° is engineered to restore.",
      },
  ...
  optimizedHuman: {
    ...
    transcript: [
      {
        time: 0,
        text: "This is Zevon again, reporting from HydrCore Base. Neural link established. Listen closely.",
      },
      {
        time: 10,
        text: "Being optimized isn't a lifestyle. It's a baseline. You don't chase energy—you engineer it.",
      },
      {
        time: 18,
        text: "Jitters are a weakness. Crashes are surrender. The second cup of coffee is a tax you pay to stay average. We don't pay taxes.",
      },
      {
        time: 29,
        text: "Being a +1 Optimized human means your HRV doesn't dip when the day gets hard. Your sleep score rises because you demand it. Your grip holds longer—because you refuse to let go.",
      },
      {
        time: 43,
        text: "You're not following. You're leading. The red horizon isn't coming. It's already here—and you're already on it.",
      },
  ...
  nftSeries: {
    ...
    transcript: [
      {
        time: 0,
        text: "You're not here for another caffeine spike. You're here for the Intel.",
      },
      {
        time: 6,
        text: "We've spent months engineering a cognitive philosophy of performance without excess. A ritual that honors your coffee cue while anchoring your focus. Now, we're ready to reveal the data.",
      },
      {
        time: 21,
        text: "Before hydrbrew° launches, we are initiating a closed-loop testing phase. We're looking for those who value verification over claims. Performance over hype.",
      },
      {
        time: 34,
        text: "This is more than a waitlist. It's an initiation. Joining the mission grants you access to the HydrCore Digital Asset Series. Every archetype character NFT embodies a specific cognitive profile, a unique path to master the loop.  Your asset is the key to unlocking mission intel, early prototype access, and a seat at the table in our biological feedback loop.",
      },
      {
        time: 63,
        text: "Share the mission to move up the rank. Unlock the game. Claim your asset.",
      },
      {
        time: 70,
        text: "Welcome to the evolution of the afternoon ritual. hydrbrew°, verification is everything.",
      },
    ],
  },
  manifesto: {
    ...
    transcript: [
      {
        time: 0,
        text: "Our manifesto is simple: Measured. Verified. Optimized. We're moving past the era of anecdotal claims and marketing hype. Consumers are increasingly skeptical of claims. We are building the first verified human data loop in the beverage industry.",
      },
      {
        time: 21,
        text: "What you see here isn't a static graphic. It's a prototype of future performance gains. Real-time biometric stabilization. Atomic equilibrium, quantified and visualized.",
      },
      {
        time: 36,
        text: "We are taking the lab into the field. Starting today, we are officially opening applications for our exclusive Beta Field Testing Group.",
      },
      {
        time: 47,
      ...
      {
        time: 65,
        text: "Sign up below for the Beta. Help us refine the loop before our full launch in late 2026. These features are currently in development for a Q4 release. hydrbrew°: Engineered for the measured life.",
      },
    ],
  },
  twoWaysToPlay: {
    ...
    transcript: [
      {
        time: 0,
        text: "The protocol is live, and there are two ways to play. Whether you're a digital scout or a field operative, your engagement fuels the loop.",
      },
      {
        time: 12,
        text: 'Phase One: Mission Intel. Join the waitlist to unlock the hunt. Four encrypted digits are hidden across the base—find them to claim one of only 100 limited-edition "Phygital" Medallions. These aren\'t just collectibles; they are your physical keys to the HydrCore VR worlds and exclusive orbital drops. The supply is strictly limited—you will be prompted via email to decode the sequence before the vault closes.',
      },
      {
        time: 42,
        text: "Phase Two: The QR Scan Event. At launch, every can of hydrbrew° becomes a live node. Scan to extract cash prizes and rare character NFTs with VR utility.",
      },
      {
        time: 55,
        text: "Beyond the rewards, each scan accelerates your optimized human state while subtracting twenty-four hours from the Global AGI Clock. Don't just wait for 2030—optimize the timeline.",
      },
      {
        time: 71,
        text: "8 cash prizes. 16 Character NFTs. Unlimited entries. The more you scan, the higher your probability of extraction. Don't just observe the future—accelerate it.",
      },
      {
        time: 85,
        text: "Join the hunt in Mission Intel or prepare for the Scan Event at launch. Two paths. One goal: Total optimization. hydrbrew°: The game is on.",
      },
    ],
  },
  transmitTheSignal: {
    ...
    transcript: [
      {
        time: 0,
        text: "A single node is a curiosity. A network is a force. To achieve a truly optimized human structure, we must scale the perimeter. This isn't just about the product; it's about the collective frequency we are establishing.",
      },
      {
        time: 19,
        text: "The archetypes on HydrCore Base—Zevon, Vespara, Luno, Zenara—aren't just characters. They are mirrors. They represent the cognitive and physical facets of our own potential. To understand them is to understand yourself.",
      },
      {
        time: 39,
        text: "But this lore is not meant to be held in isolation. It is meant to be passed on. By onboarding others into the protocol, you unlock rewards that accelerate your own status within the base. Every referral is a signal transmitted.",
      },
      {
        time: 57,
        text: "Help us build the architecture of the future. Share your link. Sync the network. Transmit the signal. The more nodes we activate, the faster we optimize the timeline.",
      },
      {
        time: 71,
        text: "I am Zevon. You are a +1. The signal is yours to carry.",
      },
    ],
  },
  theAntidote: {
    ...
    transcript: [
      {
        time: 0,
        text: "Standard coffee is a loan against your future energy—a high-interest debt that eventually comes due. We engineered hydrbrew° to be the antidote. It's about lightness, not gravity. Optimization, not depletion.",
      },
      {
        time: 18,
        text: "Observe the focus curve. By balancing our substrate, we've neutralized the cortisol spike. You'll see less than a five-beat-per-minute increase in resting heart rate. This keeps your system in parasympathetic flow—clean clarity without the anxiety cascade.",
      },
      {
        time: 36,
        text: "The exit pathway is just as precise. Low sugar means a stable insulin curve and no afternoon collapse. Instead of draining you, our electrolyte layer restores. You aren't just working; you're recovering in real-time.",
      },
      {
        time: 53,
        text: "We've kept the ritual of the cold brew taste but stripped away the systemic baggage. It's shelf-stable and ready for the field. This is how you arbitrage the now to secure a +1 baseline. This is how you become +1 You.",
      },
      {
        time: 73,
        text: "The old paradigm is heavy. The new protocol is here. I am Zevon. You are the +1 optimized human.",
      },
    ],
  },
  founderClosing: {
    ...
    transcript: [
      {
        time: 0,
        text: "This is Louis Caverly, founder of hydrbrew°. Thanks for visiting. You've breached the perimeter of the +1 Human experience. We've spent enough time in the simulation of 'standard' coffee. It's time to move into the high-fidelity reality of total optimization. The +1 You.",
      },
...
export function NeuralBriefing() {
  ...
  const [activeBriefingId, setActiveBriefingId] =
    useState<string>("precursorModel");
  ...
  const currentBriefing = (briefings[lockedBriefingId || activeBriefingId] ||
    briefings.precursorModel)!;
  ...
  useEffect(() => {
    ...
    window.addEventListener(
      "neuralBriefingTrigger",
      handleTrigger as EventListener,
    );
    window.addEventListener(
      "openNeuralBriefing",
      handleOpenBriefing as EventListener,
    );
  ...
  const waveformBars = Array.from({ length: 40 }, (_, i) => {
    ...
    const playingModifier = isPlaying
      ? Math.sin((currentTime + i) * 2) * 20
      : 0;
  ...
  const getCurrentTranscriptIndex = () => {
    for (let i = currentBriefing.transcript.length - 1; i >= 0; i--) {
      if (currentTime >= currentBriefing.transcript[i]!.time) {
        return i;
      }
    }
    return 0;
        ...
        {!isOpen && (
          ...
          >
            <div className="relative">
              ...
              {/* Main button */}
              <motion.div
                className="relative w-16 h-16 bg-black rounded-full flex items-center justify-center transition-all group-hover:scale-110"
                style={{
              ...
              {/* Corner accents */}
              <div
                className="absolute -top-1 -left-1 w-3 h-3 rounded-tl"
                style={{
              ...
              />
              <div
                className="absolute -top-1 -right-1 w-3 h-3 rounded-tr"
                style={{
                  borderTop: "2px solid rgba(0, 255, 255, 0.6)",
                  borderRight: "2px solid rgba(0, 255, 255, 0.6)",
                }}
              />
              <div
                className="absolute -bottom-1 -left-1 w-3 h-3 rounded-bl"
                style={{
              ...
              />
              <div
                className="absolute -bottom-1 -right-1 w-3 h-3 rounded-br"
                style={{
                  borderBottom: "2px solid rgba(0, 255, 255, 0.6)",
                  borderRight: "2px solid rgba(0, 255, 255, 0.6)",
                }}
          ...
          <>
            ...
            >
              <div className="relative">
                ...
                <div
                  className="absolute -inset-1 rounded-2xl blur-lg opacity-75"
                  style={{
                    background:
                ...
                <div className="relative bg-neutral-950 border-2 border-cyan-500/70 rounded-2xl overflow-hidden shadow-2xl">
                    ...
                    <div className="relative flex items-center justify-between">
                      <div className="flex items-center gap-3">
                        ...
                        <div className="relative w-10 h-10">
                          ...
                          {currentBriefing.id === "founderClosing" &&
                            isPlaying && (
                              <>
                                {/* Rotating sunbeams */}
                                <motion.div
                  ...
                  <div
                    ref={transcriptRef}
                    className="relative px-4 py-4 bg-neutral-950/50 border-t border-cyan-500/20 max-h-32 overflow-y-auto custom-scrollbar"
                  >
