...
interface TwoWaysToPlayProps {
  onToggleMissionIntel: () => void;
  onToggleScanEvent: () => void;
  missionIntelOpen: boolean;
  scanEventOpen: boolean;
}

export function TwoWaysToPlay({
  onToggleMissionIntel,
  onToggleScanEvent,
  missionIntelOpen,
  scanEventOpen,
}: TwoWaysToPlayProps) {
  ...
  useEffect(() => {
    const update = () => setSquareCount(Math.ceil(window.innerWidth / 50));
    update();
  ...
  return (
    <section
      id="two-ways-to-play"
      ref={ref}
      className="py-24 md:py-32 bg-neutral-800 relative overflow-hidden hidden"
    >
      {/* Background elements */}
      <div className="absolute inset-0 overflow-hidden">
        ...
        <div
          ...
          style={{
            ...
            filter:
              "grayscale(20%) contrast(1.4) brightness(0.8) saturate(1.2)",
          }}
        />
        ...
        <div className="absolute inset-0 bg-gradient-to-br from-cyan-500/10 via-transparent to-purple-500/10 mix-blend-hard-light" />
        ...
        <div className="absolute top-0 left-0 right-0 flex">
          {Array.from({ length: squareCount }).map((_, i) => {
            ...
            const color = colors[i % colors.length] ?? "#06b6d4";
        ...
        >
          ...
          <div className="inline-block bg-black/40 backdrop-blur-md border border-cyan-500/20 rounded-3xl px-8 py-10 shadow-[0_8px_32px_rgba(0,0,0,0.4)]">
            ...
            <p className="text-lg text-neutral-300 max-w-2xl mx-auto leading-relaxed">
              Claim your digital identity. Your{" "}
              <span className="text-cyan-400 font-semibold">NFT</span> mirrors
              your focus style and unlocks exclusive rewards.
            </p>
          </div>
        </motion.div>
            ...
            <div className="bg-gradient-to-br from-neutral-900 via-neutral-950 to-black border border-red-500/30 rounded-2xl p-8 h-full relative overflow-hidden">
              ...
              <div className="relative z-10">
                ...
                <p className="text-neutral-400 mb-8 leading-relaxed">
                  Decrypt codes hidden in HydrCore Base to claim your exclusive
                  Medallion before launch.
                </p>
                    ...
                    <div className="flex-1">
                      <div className="flex items-center gap-2 mb-1">
                        ...
                        <h4 className="text-white font-medium">
                          Sign Up for Protocol Drops
                        </h4>
                      </div>
                      <p className="text-neutral-400 text-sm">
                        Subscribe to receive mission briefings
                      </p>
                    </div>
                  </motion.div>
                  ...
                  >
                    ...
                    <div className="flex-1">
                      <div className="flex items-center gap-2 mb-1">
                        ...
                        <h4 className="text-white font-medium">
                          Hunt for Secret Codes
                        </h4>
                      </div>
                      <p className="text-neutral-400 text-sm">
                        Codes drop in HydrCore Base via email alerts
                      </p>
                    </div>
                  </motion.div>
                  ...
                  >
                    ...
                    <div className="flex-1">
                      <div className="flex items-center gap-2 mb-1">
                        ...
                        <h4 className="text-white font-medium">
                          Claim Your Medallion
                        </h4>
                      </div>
                      <p className="text-neutral-400 text-sm">
                        Enter code in Mission Intel to unlock rewards
                      </p>
                    </div>
                  </motion.div>
                </div>
                ...
                <button
                  onClick={() => {
                    onToggleMissionIntel();
                    // Auto-scroll to section when opening (not closing)
                    if (!missionIntelOpen) {
                      setTimeout(() => {
                ...
                >
                  ...
                  <motion.svg
                    ...
                    fill="none"
                    animate={
                      missionIntelOpen ? { rotate: 180 } : { x: [0, 4, 0] }
                    }
                    transition={
                      missionIntelOpen
                        ? { duration: 0.3 }
          ...
          >
            <div className="bg-gradient-to-br from-neutral-900 via-neutral-950 to-black border border-emerald-500/30 rounded-2xl p-8 h-full relative overflow-hidden">
              ...
              <div className="relative z-10">
                ...
                <p className="text-neutral-400 mb-8 leading-relaxed">
                  Scan to win cash and limited NFTs—exclusive to the first
                  product release.
                </p>
                ...
                <div className="bg-black/40 border border-emerald-500/20 rounded-lg p-4 mb-6">
                  <p className="text-neutral-300 text-sm leading-relaxed">
                    ...
                    No purchase necessary. One scan per 24-hour period.
                  </p>
                </div>
                ...
                <button
                  onClick={() => {
                    ...
                    if (!scanEventOpen) {
                      setTimeout(() => {
                        const section = document.getElementById("scan-event");
                        if (section) {
                          section.scrollIntoView({
                            behavior: "smooth",
                            block: "start",
                ...
                >
                  ...
                  <motion.svg
                    ...
                    viewBox="0 0 24 24"
                    fill="none"
                    animate={scanEventOpen ? { rotate: 180 } : { y: [0, 4, 0] }}
                    transition={
                      scanEventOpen
                        ? { duration: 0.3 }
                        : { duration: 1.5, repeat: Infinity }
        ...
        >
          <div className="inline-block bg-black/30 backdrop-blur-sm border border-neutral-700/30 rounded-full px-6 py-3">
            <p className="text-neutral-300 text-sm font-mono">
              Both games reward early adopters who engage with the hydrbrew°
              ecosystem
            </p>
          </div>
        </motion.div>
