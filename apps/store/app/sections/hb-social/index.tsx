...
const TESTIMONIALS = [
  "The morning I switched to hydrbrew° I stopped dreading 3pm.",
  "Finally — caffeine that doesn't hijack my evening.",
  "Same ritual. Zero systemic debt. The night is actually mine now.",
  "This is what afternoon focus is supposed to feel like.",
];
...
function HbSocial(props: HydrogenComponentProps) {
  ...
  return (
    <section {...rest} className="py-20 md:py-32 bg-black overflow-hidden">
      <div className="max-w-7xl mx-auto px-4 md:px-8">
        <div className="text-center mb-16">
          ...
          <h2 className="text-5xl md:text-7xl font-bold text-white mb-4" style={{ fontFamily: "'Urbanist',sans-serif" }}>
            The Baseline <span style={{ color: "#00FFFF" }}>Standard</span>
          </h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-24">
          {TESTIMONIALS.map((text, i) => (
            <div
              ...
              style={{ border: "1px solid rgba(0,255,255,0.2)", background: "linear-gradient(135deg,rgba(0,255,255,0.05),rgba(128,0,255,0.05))" }}
            ...
            >
              <div className="flex mb-3">
                {[1,2,3,4,5].map((s) => <span key={s} style={{ color: "#00FFFF", fontSize: 14 }}>★</span>)}
              </div>
              <p className="text-white/90 text-sm leading-relaxed" style={{ fontFamily: "'Urbanist',sans-serif" }}>"{text}"</p>
            </div>
          ))}
        </div>

        <div className="rounded-2xl p-8 md:p-12 text-center" style={{ border: "2px solid rgba(0,255,255,0.3)", backgroundColor: "#000" }}>
          ...
          <a href="https://www.instagram.com/tryhydrbrew/" target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-2 text-white/60 hover:text-[#00FFFF] transition-colors text-sm" style={{ fontFamily: "'Space Grotesk',sans-serif" }}>
