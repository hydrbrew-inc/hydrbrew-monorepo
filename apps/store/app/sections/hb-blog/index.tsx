...
const ARTICLES = [
  {
    title: "The L-Theanine + Caffeine Stack: A Science Review",
    excerpt: "How the combination of caffeine and L-Theanine may support sustained cognitive performance — and why the ratio matters.",
    badge: "SCIENCE REVIEW",
    slug: "l-theanine-caffeine-stack-science-review",
  },
  {
    title: "The Afternoon Manifesto",
    excerpt: "A structural correction for the pre-sovereign era. Why the 2:15 PM window defines your day.",
    badge: "MANIFESTO",
    slug: "afternoon-manifesto",
  },
  {
    title: "Lion's Mane & Neuroplasticity",
    excerpt: "What the research actually says about hericenones, NGF synthesis, and cognitive support.",
    badge: "RESEARCH",
    slug: "lions-mane-neuroplasticity",
  },
];

function HbBlog(_props: SectionProps) {
  return (
          ...
          {ARTICLES.map((article) => (
            ...
            >
              ...
              <div
                ...
                style={{ background: "linear-gradient(135deg, rgba(0,255,255,0.1), rgba(128,0,255,0.1))" }}
              >
              ...
              <div className="p-6">
                <span
                  ...
                  style={{ backgroundColor: "rgba(0,255,255,0.1)", border: "1px solid rgba(0,255,255,0.3)", color: "#00FFFF", fontFamily: "'Roboto Mono', monospace" }}
                >
                  {article.badge}
                </span>
                ...
                <p className="text-sm text-white/60 line-clamp-2 mb-4" style={{ fontFamily: "'Urbanist', sans-serif" }}>
                  {article.excerpt}
                </p>
                <span className="text-sm font-bold transition-all duration-200 group-hover:gap-3 flex items-center gap-2" style={{ color: "#00FFFF", fontFamily: "'Urbanist', sans-serif" }}>
                  Read Article →
                </span>
              </div>
            </Link>
