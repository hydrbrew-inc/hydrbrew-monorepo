...
interface HbProductProps extends SectionProps {
  ctaLink?: string;
}
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 md:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 md:gap-16 items-center mb-24">
          ...
          <div className="flex justify-center">
            <div
              className="relative max-w-sm w-full aspect-[3/4] rounded-lg overflow-hidden"
              style={{ border: "2px solid rgba(0,255,255,0.3)", background: "linear-gradient(135deg, rgba(0,255,255,0.1), transparent)" }}
            >
              <img
                src="/can-front.webp"
                alt="hydrbrew° can"
                className="w-full h-full object-contain p-8"
                style={{ filter: "drop-shadow(0 20px 60px rgba(0,255,255,0.15))" }}
              />
            </div>
          </div>
          ...
          <div>
            <p className="font-mono text-sm uppercase tracking-widest mb-3" style={{ color: "#00FFFF", fontFamily: "'Roboto Mono', monospace" }}>
              12-PACK // 12 OZ SLEEK CANS
            </p>
            <h2 className="text-5xl md:text-6xl font-bold text-white mb-2 uppercase" style={{ fontFamily: "'Urbanist', sans-serif" }}>
              FUNCTIONAL
            </h2>
            <h2 className="text-5xl md:text-6xl font-bold text-white mb-4 uppercase" style={{ fontFamily: "'Urbanist', sans-serif" }}>
              ICED COFFEE
            </h2>
            <p className="text-2xl font-medium text-white mb-6" style={{ fontFamily: "'Urbanist', sans-serif" }}>
            ...
            <p className="text-sm mb-8" style={{ color: "#00FFFF", fontFamily: "'Roboto Mono', monospace" }}>
              200mg L-Theanine // 200mg Lion's Mane // 85mg Caffeine
            </p>

            <Link
              to={ctaLink}
              className="block w-full text-center py-4 rounded-xl font-bold text-black text-lg uppercase tracking-wider transition-all duration-300 hover:opacity-90"
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center mb-24">
          <div>
            <h2 className="text-6xl md:text-7xl font-bold text-white mb-6" style={{ fontFamily: "'Urbanist', sans-serif", lineHeight: 1.1 }}>
          ...
          <div className="flex justify-center">
            <div
              className="relative max-w-xs w-full aspect-square rounded-lg overflow-hidden"
              style={{ border: "2px solid rgba(0,255,255,0.3)", background: "linear-gradient(135deg, rgba(0,255,255,0.1), transparent)" }}
            >
              <img
                src="/can-front.webp"
                ...
                style={{ transform: "rotate(15deg) scale(1.2)", filter: "drop-shadow(0 20px 40px rgba(0,0,0,0.5))" }}
              />
            </div>
          </div>
        </div>
        ...
        {/* Comparison Table */}
        <div>
          <p className="font-mono text-xs uppercase tracking-widest mb-4 text-center" style={{ color: "#00FFFF", fontFamily: "'Roboto Mono', monospace" }}>
            CATEGORY ANALYSIS // COMPETITIVE MATRIX
          </p>
          <h2 className="text-5xl md:text-7xl font-bold text-white text-center mb-12" style={{ fontFamily: "'Urbanist', sans-serif" }}>
            How We Stack Up
          </h2>
          ...
          <div className="overflow-x-auto" style={{ border: "1px solid rgba(0,255,255,0.2)", borderRadius: 12 }}>
            <table className="w-full">
              <thead>
                <tr style={{ backgroundColor: "#0B0B0B", borderBottom: "2px solid #00FFFF" }}>
                  {["PRODUCT", "BEST WINDOW", "NOOTROPIC STACK"].map((h) => (
                    <th key={h} className="px-6 py-4 text-left text-xs font-bold uppercase tracking-wider" style={{ color: "#00FFFF", fontFamily: "'Roboto Mono', monospace" }}>
                      {h}
                    </th>
                  ))}
                </tr>
              ...
              <tbody>
                {[
                  { name: "RTD Coffee (La Colombe)", window: "Morning", stack: "Absent", hero: false },
                  { name: "Functional Water (Liquid I.V.)", window: "Anytime", stack: "Absent", hero: false },
                  { name: "Nootropic Drinks (Kin)", window: "Evening", stack: "Partial", hero: false },
                ].map((row) => (
                ...
                {/* hydrbrew hero row */}
                <tr style={{ backgroundColor: "rgba(0,255,255,0.05)", borderLeft: "4px solid #00FFFF", boxShadow: "0 0 30px rgba(0,255,255,0.1)" }}>
  ...
  settings: [
    {
      group: "Content",
      inputs: [
        { type: "text", name: "ctaLink", label: "CTA Link", defaultValue: "/products/hydrbrew-pre-order-bundle" },
      ],
    },
    ...sectionSettings,
  ],
