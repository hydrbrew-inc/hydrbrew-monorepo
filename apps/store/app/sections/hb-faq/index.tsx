...
const FAQS = [
  ...
  { q: "When is the best time to drink hydrbrew°?", a: "The 2:15 PM window — the point in the afternoon when morning caffeine has worn off and the demand for sustained cognitive output remains high. Noon to 6 PM is the designed window." },
...
function HbFaq(_props: SectionProps) {
      ...
      <div className="max-w-3xl mx-auto px-4">
        ...
        <div className="text-center mb-16">
          ...
          <h2 className="text-5xl md:text-7xl font-bold text-white mb-4" style={{ fontFamily: "'Urbanist', sans-serif" }}>
            The{" "}
            <span style={{ color: "#00FFFF" }}>Knowledge Base</span>
          </h2>
          ...
          {FAQS.map((faq, i) => (
            <div
              ...
              style={{
                ...
                background: "linear-gradient(135deg, rgba(0,255,255,0.03), rgba(128,0,255,0.03))",
              }}
            >
              <button
                ...
                onMouseEnter={(e) => { if (open !== i) (e.currentTarget as HTMLElement).style.color = "#00FFFF"; }}
                onMouseLeave={(e) => { if (open !== i) (e.currentTarget as HTMLElement).style.color = "#FFFFFF"; }}
              >
                <span className="font-medium text-base md:text-lg pr-4" style={{ fontFamily: "'Urbanist', sans-serif" }}>
                  {faq.q}
                </span>
                <span className="text-xl shrink-0 transition-transform duration-300" style={{ transform: open === i ? "rotate(45deg)" : "rotate(0deg)" }}>
                  +
                </span>
              </button>
              {open === i && (
                <div className="px-6 pb-6">
                  <p className="text-white/70 leading-relaxed" style={{ fontFamily: "'Urbanist', sans-serif", fontWeight: 300 }}>
                    {faq.a}
                  </p>
                </div>
              )}
