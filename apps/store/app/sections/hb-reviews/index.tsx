...
interface HbReviewsProps extends SectionProps {
  headline?: string;
  subtext?: string;
  ctaText?: string;
  ctaLink?: string;
  ...
  return (
    ...
    >
      ...
      <img
        ...
        style={{ objectPosition: "65% center", opacity: 0.35, filter: "contrast(1.2) saturate(0.8)" }}
      />
      {/* Overlay */}
      <div className="absolute inset-0 bg-black/50" />
      <div
        className="absolute inset-0 pointer-events-none"
        style={{ background: "radial-gradient(ellipse 80% 60% at 50% 50%, rgba(0,255,255,0.04) 0%, transparent 70%)" }}
      />

      {/* Content */}
      <div className="relative z-10 flex flex-col items-center justify-center text-center min-h-[560px] px-4 py-20">
        <h2
          className="text-5xl md:text-7xl lg:text-8xl font-bold text-white uppercase mb-6"
          style={{ fontFamily: "'Urbanist', sans-serif" }}
        >
          {headline}
        </h2>
        <p
          className="text-xl md:text-2xl text-white/90 italic max-w-3xl mb-10"
