        ...
        {data?.metaPixelId && (
          <>
            <script
              nonce={nonce}
              suppressHydrationWarning
              // biome-ignore lint/security/noDangerouslySetInnerHtml: trusted pixel init, ID from env var
              dangerouslySetInnerHTML={{
            ...
            />
            <noscript
              // biome-ignore lint/security/noDangerouslySetInnerHtml: standard Meta Pixel noscript fallback
              dangerouslySetInnerHTML={{
                __html: `<img height="1" width="1" style="display:none" src="https://www.facebook.com/tr?id=${data.metaPixelId}&ev=PageView&noscript=1"/>`,
              }}
            />
          </>
        )}
        {data?.gaMeasurementId && (
          <>
            <script
              nonce={nonce}
              suppressHydrationWarning
              // biome-ignore lint/security/noDangerouslySetInnerHtml: trusted GA4 init, ID from env var
              dangerouslySetInnerHTML={{
                __html: `window.dataLayer=window.dataLayer||[];window.gtag=function gtag(){window.dataLayer.push(arguments)};gtag('js',new Date());gtag('config','${data.gaMeasurementId}',{send_page_view:false});`,
              }}
            />
            <script
              async
